        ...
        <div className="overflow-x-auto pb-4">
            ...
            <div className="min-w-[300px] bg-white shadow-md rounded-lg p-4">
                ...
                {selectedItem?.title.includes('Hills') && (
                    <DetailModal data={items[0]} onClose={() => setSelectedItem(null)} />
                )}
            </div>
            ...
            <div className="min-w-[300px] bg-white shadow-md rounded-lg p-4">
                ...
                {selectedItem?.title.includes('Lake') && (
                    <DetailModal data={items[1]} onClose={() => setSelectedItem(null)} />
                )}
            </div>
            ...
            <div className="min-w-[300px] bg-white shadow-md rounded-lg p-4">
                ...
                {selectedItem?.title.includes('Pool') && (
                    <DetailModal data={items[2]} onClose={() => setSelectedItem(null)} />
                )}
            </div>
            </div>
        </div>
