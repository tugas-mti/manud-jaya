...
export default function SocialMedia() {
  return (
    ...
    <div className="container mx-auto p-4 space-y-8">
        {/* Main Title */}
        <h2 className="text-3xl font-bold mb-8">Follow Us on Our Social Media</h2>
        ...
        <section className="flex flex-col items-center space-y-4 w-full">
            ...
            <Image src="/socials/instagram.png" alt="Instagram Logo" width={30} height={30} />
            <h2 className="text-2xl font-semibold">@ManudJayaTourismVillage</h2>
            </div>
